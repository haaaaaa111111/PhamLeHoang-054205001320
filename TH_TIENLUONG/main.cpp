...
void nhapCung(vector<TienLuong*>& danhSachLuong)
{
	...
	danhSachLuong.push_back(new PartTime("2904D", "Nguyen D", "5/3/2019", "0102345678", 22000000, 36, 500000));
	danhSachLuong.push_back(new PartTime("2904E", "Nguyen E", "5/3/2019", "0201345678", 18200000, 33, 400000));
}
// nhap danh sach
void nhapdanhSachTienLuong(vector<TienLuong*>& danhSachLuong) {
	...
	for (int i = 0; i < luongParTime; i++) {
		...
		cout << "Tong Luong: ";
		cin >> tongLuong;
		danhSachLuong.push_back(new PartTime(maNhanVien, hoTenNhanVien, ngayVaoLam, soDienThoai, tongLuong, soGioLamTuan, mucLuongMoiGio));
	}
}
